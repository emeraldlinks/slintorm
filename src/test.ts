...
import type {
  User, Track, Cohort, Application, PPT, Enrollment, Module, Assessment,
  Submission, Certification, Tutor, TutorAssignment, CourseClass, Timetable,
  PlacementPartner, Message, PortfolioItem, JobListing, Placement, AlumniReport,
  Announcement, Attendance, ActivityLog, Payment
} from "./interfaces.js";
