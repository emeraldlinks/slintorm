...
// import ORMManager, { DBStore } from "slintorm";
...
//   // @relation onetomany:Cohort;foreignKey:trackId
//   cohorts?: Cohort[];
//   // @relation onetomany:Enrollment;foreignKey:trackId
...
//     const enrollment = await db.Enrollment.query()
//   .preload("user")
//   .preload("cohort")
//   .first();
...
//     isRequired: true,
//   });
//   console.log("Inserted Assessment:", dmAssess1);
// const id = dmAssess1?.id;

// const assessment = await db.Assessment.query()
// .relatedTo("Module", "enrollmentId", enrollment?.id)
...
//   console.log("Assessment with related data:", assessment);
// }
